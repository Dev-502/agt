 ...
 *
 *
 * @package    propel.generator.AnimeGT.AnimeGT.Base
 */
abstract class Videos implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\AnimeGT\\AnimeGT\\Map\\VideosTableMap';
    ...
    /**
     * The value for the episode field.
     *
     * @var        string
     */
    protected $episode;
    ...
    /**
     * Initializes internal state of AnimeGT\AnimeGT\Base\Videos object.
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[VideosTableMap::COL_ID] = true;
        }
    ...
    /**
     * Set the value of [eid] column.
     *
     * @param string $v new value
     * @return $this|\AnimeGT\AnimeGT\Videos The current object (for fluent API support)
     */
    public function setEid($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->eid !== $v) {
            $this->eid = $v;
            $this->modifiedColumns[VideosTableMap::COL_EID] = true;
        }
    ...
    public function setUrl($v)
    {
        ...
        if ($this->url !== $v) {
            $this->url = $v;
            $this->modifiedColumns[VideosTableMap::COL_URL] = true;
        }
    ...
    /**
     * Set the value of [episode] column.
     *
     * @param string $v new value
     * @return $this|\AnimeGT\AnimeGT\Videos The current object (for fluent API support)
     */
    public function setEpisode($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->episode !== $v) {
            $this->episode = $v;
            $this->modifiedColumns[VideosTableMap::COL_EPISODE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : VideosTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : VideosTableMap::translateFieldName('Eid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->eid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : VideosTableMap::translateFieldName('Url', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\AnimeGT\\AnimeGT\\Videos'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(VideosTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(VideosTableMap::COL_EID)) {
            $modifiedColumns[':p' . $index++]  = 'eid';
        }
        if ($this->isColumnModified(VideosTableMap::COL_URL)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id':
                        ...
                        break;
                    case 'eid':
                        $stmt->bindValue($identifier, $this->eid, PDO::PARAM_STR);
                        break;
                    case 'url':
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\AnimeGT\AnimeGT\Videos
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\AnimeGT\AnimeGT\Videos The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VideosTableMap::COL_ID)) {
            $criteria->add(VideosTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(VideosTableMap::COL_EID)) {
            $criteria->add(VideosTableMap::COL_EID, $this->eid);
        }
        if ($this->isColumnModified(VideosTableMap::COL_URL)) {
            $criteria->add(VideosTableMap::COL_URL, $this->url);
        }
        if ($this->isColumnModified(VideosTableMap::COL_EPISODE)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \AnimeGT\AnimeGT\Videos (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \AnimeGT\AnimeGT\Videos Clone of current object.
     * @throws PropelException
     */
