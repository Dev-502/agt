...
class httpProxy {
	...
	*/
	 ...
	 */
	public function performRequest($url, $requestType = 'GET', $postFields = array(), $headers = array(),$timeout=3){
		...
		//Timeout
		curl_setopt($curlResource, CURLOPT_CONNECTTIMEOUT ,0);
		curl_setopt($curlResource, CURLOPT_TIMEOUT, $timeout); //timeout in seconds
